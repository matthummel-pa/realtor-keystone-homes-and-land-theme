...
Copied from `web/app/themes/ridgesandvalleys-theme/concept/realtor-keystone-homes-and-land/` in [matthummel-pa/ridgesandvalleys](https://github.com/matthummel-pa/ridgesandvalleys). Future updates belong here, not in the marketing site repo.
